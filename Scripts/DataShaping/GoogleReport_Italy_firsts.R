...
dat <- dat[dat$country_region == COUNTRY & dat$date >= as.Date(START_DATE),]
dat <- dat[dat$sub_region_1 == "Lombardy" | dat$sub_region_1 == "Veneto" | dat$sub_region_1 == "Emilia-Romagna",]

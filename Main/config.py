...
simList['Default'] = {
	...
	# Fitting parameters
	'fitMethod': 'SMC',	# Valid values are SMC and BOLFI.
	'degreeBOLFI': 2,		# Order of approximant
	'nParticles': 200,  	# Number of particles for fitting procedure
	...
	'fitRate': 0.30,        # Fraction of discarded particles
...
simList['UK']   = {'mobility': 0.437, 'simLen': 365, 'R0': 2.5, 'model': 'consensus', 't0': 21, 'nParticles': 41, 'households': 'yes', 'betaMul': 1.28797, 
					'avgFamilySize': 2.4, 'weeklyWorkHours': 37.5, 'importOmega': 0.01}
simList["Spain"] = {'mobility': 0.189, 'nParticles': 41, 'avgFamilySize': 2.50, 'betaMul': 1.26042, 'weeklyWorkHours': 40.5, 'importOmega': 0.01}
